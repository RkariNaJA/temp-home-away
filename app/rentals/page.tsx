...
import { formatCurrency } from "@/utils/format"; //Diplay price
import {
  Table,
  TableBody,
  TableCaption,
...
import FormContainer from "@/components/form/FormContainer"; //For delete functionality
import { IconButton } from "@/components/form/Buttons"; //Edit and delete button
...
async function RentalsPage() {
  ...
  return (
    <div className="mt-16">
      <h4 className="mb-4 capitalize">Total Rentals : {rentals.length}</h4>
      <Table>
...
function DeleteRental({ propertyId }: { propertyId: string }) {
  //To pass bookingId to the deleteRentalAction function
